...
class MyApp(App):
    ...
    def main(self):
        ...
        self.imgw = gui.Image(r'https://i04piccdn.sogoucdn.com/db38a92d510e60c7', height=100, margin='10px')
        self.labw = gui.Label('识别能力列表', width='100%', height='30px', style={ 'font-size':'25px'})
        self.b1w = gui.Button('表格识别', width=200, height=30, margin='10px')
        self.b2w = gui.Button('文档识别', width=200, height=30, margin='10px')
        page_mid.append([self.imgw, self.labw, self.b1w, self.b2w])
